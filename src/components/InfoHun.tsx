			...
			<article className="card">
				<div className="inv_container z1">
					...
					<p className="spectral_sc announce z3">
						Örömmel tudatjuk veletek, hogy úgy döntöttünk, szerelmünket
						házassággal pecsételjük meg. Szeretettel értesítünk, hogy
					</p>

					<div className="spectral the_date z3">2022. október 1-én</div>

					<p className="spectral_sc eternal z3">
						örök hűséget fogadunk egymásnak. A szertartást és vacsorát követően
						megkezdjük a hajnalig tartó közös ünneplést.
					</p>

					<div className="line"></div>

					<section className="spectral_sc happening z3">
						<strong>Esküvői szertartás</strong>
